 ...
 */
?>
<form class="booking-form layout1" method="post" action="./">
    <div class="row">
    	<div class="col-sm-6">
    	...
    	<div class="col-sm-6">
            <div class="bottommargin_10">
            <textarea aria-required="true" rows="2" cols="45" name="appointment-message" id="appointment-message" class="form-control" placeholder="<?php esc_html_e('Message','medix');?>"></textarea>
            </div>
        </div> 
    	<div class="col-sm-6">
            <div class="bottommargin_10">
