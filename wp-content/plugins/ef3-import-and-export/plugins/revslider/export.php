...
function ef3_revslider_export($file){
    ...
    /* if folder revslider does not exists. */
    ...
    if ( $arrSliders ) {
        ...
        foreach ( $arrSliders as $slider ) {
            ...
            $rev_file = ef3_revslider_export_slider($slider_class, $slider->getAlias(), $slider->getParams());

            rename($rev_file, $file . 'revslider/' . $slider->getAlias() . '.zip');
        }
    }
}
 ...
 */
function ef3_revslider_export_slider($slider, $alias, $sliderParams, $useDummy = false){
