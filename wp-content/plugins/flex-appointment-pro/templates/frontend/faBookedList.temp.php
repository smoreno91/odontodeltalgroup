<div class="fa-booked-appt-list">
    <h4>
        <span><?php esc_html_e('Available Appointments on','flex-appointments')?> </span><strong><?php echo $date ?></strong><span></span>
    </h4>
    <?php
            ...
            <span class="fa-timeslot-book">
                ...
                if ($spaces == 0):?>
                    <button class="fa-new-appt-unavaiabale">
                        <span class="fa-button-text btn btn-default"><?php esc_html_e('UNAVAILABLE','flex-appointments')?></span>
                    </button>
                    <?php
                else:
                    ?>
                    <button data-timeslot="<?php echo $time ?>" data-date="<?php echo $format_date ?>"
                            class="fa-new-appt">
                        <span class="btn btn-primary fa-button-text"><?php esc_html_e('APPOINTMENT','flex-appointments')?></span>
                    </button>
                    <?php
                endif;
                ?>
