...
if (! class_exists ( 'UserPress_admin' )) {
	...
	class UserPress_admin {  
		...
		function register_plugin_settings() {
			...
			register_setting('user-press-social_login-group', 'up_twitter_consumer_key');
            register_setting('user-press-social_login-group', 'up_twitter_consumer_secret');
            register_setting('user-press-social_login-group', 'up_twitter_callback_url');
		...
		private function option_text($options){
			...
			<tr valign="top">
				...
				<td class="forminp">
					<input name="<?php echo esc_attr( $options['id'] ); ?>" id="<?php echo esc_attr( $options['id'] ); ?>" type="text" value="<?php echo esc_attr( $option_value ); ?>" placeholder="<?php echo isset($options['placeholder']) ? esc_attr( $options['placeholder'] ) : ''; ?>" />
                                        <label><?php echo isset($options['description'])? $options['description'] : '' ?></label>
				</td>
			</tr>
			<?php
		}
