...
var wpAjaxUrl='http://odontodentalgroup.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://odontodentalgroup.com/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://odontodentalgroup.com/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://odontodentalgroup.com/wp-admin/admin-ajax.php'},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){$('.fl-node-5a32ea4d23149 .fl-gallery-item').wookmark({align:'center',autoResize:true,container:$('.fl-node-5a32ea4d23149 .fl-gallery'),offset:0,itemWidth:150});});})(jQuery);