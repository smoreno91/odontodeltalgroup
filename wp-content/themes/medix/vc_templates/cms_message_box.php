...
$title = !empty($title) ? $title : 'Well done!';
$message = !empty($message) ? $message : ' You successfully read this important alert message.';
...
<div class="<?php echo esc_attr($css_class);?>">
    ...
    <div class="alert <?php echo esc_attr($message_type);?>" role="alert">
		...
		<strong><?php echo esc_html($title);?></strong> <?php echo esc_html($message);?>
	</div>
</div>
<?php endif;?>
