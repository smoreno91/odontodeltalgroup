 ...
 */
$source = $text = $link = $google_fonts = $font_container = $el_id = $el_class = $css = $css_animation = $font_container_data = $google_fonts_data = $uppercase = $thin = '';
...
if($uppercase == '1') $css_class .= ' uppercase';  
if($thin == '1') $css_class .= ' thin';  
