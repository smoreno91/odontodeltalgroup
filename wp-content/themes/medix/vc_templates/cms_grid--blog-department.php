<?php 
    /* get categories */
        ...
        $word_number = !empty($atts['word_number']) ? $atts['word_number'] : '30';
...
?>
<div class="cms-grid-wraper blog-grid-department <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="cms-grid-item <?php echo esc_attr($atts['item_class']);?> to_animate wow fadeIn" data-wow-delay="<?php echo esc_attr($delay);?>ms" data-groups='[<?php echo implode(',', $groups);?>]'>
                <article id="post-<?php the_ID(); ?>" <?php post_class('medix-blog-loop'); ?>>
                    ...
                    ?>   
                        ...
                        <div class="entry-wrap text-center">
                        	<header class="entry-header">
                        		<?php the_title( '<h3 class="entry-title highlight text-uppercase"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h3>' ); ?>
                        	</header> 
                    ...
                    <?php break; default: ?>
                        ...
                        <?php medix_post_thumbnail('medium'); ?>
                        </a>
                        <div class="entry-wrap text-center">
                        	<header class="entry-header">
                        		<?php the_title( '<h3 class="entry-title highlight text-uppercase"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h3>' ); ?>
