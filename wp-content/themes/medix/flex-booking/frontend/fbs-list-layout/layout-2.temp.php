 ...
 */
?>
<form class="booking-form layout2" method="post" action="./" style="position: relative;">
    <div class="row">
    	<div class="col-sm-6">
    	...
    	<div class="col-sm-12">
            <div class="bottommargin_10">
            <textarea aria-required="true" rows="6" cols="45" name="fa-app-message" id="fa-app-message" class="form-control fa-app-message" placeholder="<?php esc_html_e('Message','medix');?>"></textarea>
            </div>
        </div> 
    	<div class="col-sm-12">
