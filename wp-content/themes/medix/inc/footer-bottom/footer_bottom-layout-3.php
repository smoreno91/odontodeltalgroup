...
echo '<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 text-left">';
    ...
    echo "</div>";
echo "</div>";
echo '<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 text-center footer-bottom-logo">';
...
echo "</div>";
echo '<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 text-right col-right">';
        if ( is_active_sidebar( 'sidebar-footer-bottom-layout-3-right') ){
            dynamic_sidebar( 'sidebar-footer-bottom-layout-3-right' );
        } 
echo "</div>";
?>