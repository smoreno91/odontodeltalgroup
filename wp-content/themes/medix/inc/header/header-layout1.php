    ...
    <div class="main-header-wrap">
        <div class="<?php echo esc_attr($full_width_class);?>">
            <div class="main-header-outer">
                ...
                <?php if(isset($theme_options['hide_social']) && $theme_options['hide_social'] == '0'): ?>    
                <div class="text-right hidden-xs socials">
                    <?php 
                    if((is_page() && !empty($meta_options['header_transparent']) && $meta_options['header_transparent'] == '1' ))
                        medix_social_from_themeoption('header','color-icon bg-icon','rounded-icon');
                    else
                        medix_social_from_themeoption('header','color-bg-icon','rounded-icon');
                     ?>
    			</div>
                <?php endif; ?>
            </div>
