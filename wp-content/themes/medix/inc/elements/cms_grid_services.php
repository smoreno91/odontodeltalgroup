...
vc_map(
	array(
		"name" => esc_html__("CMS Grid Services", 'medix'),
	    ...
	    "params" => array(
            ...
            array(
                ...
                'description' => esc_html__( 'Enter the number of word to display', 'medix' ),
...
class WPBakeryShortCode_cms_grid_services extends CmsShortCode{
	protected function content($atts, $content = null){
		...
		wp_enqueue_script('medix-cms-grid-service-pagination',get_template_directory_uri().'/inc/elements/js/cmsgrid.pagination.js',array('jquery'),'1.0.0',true);
